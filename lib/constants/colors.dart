...
class AppColors {
  ...
  static Color get CLR_ERROR => isElite ? Color(0xffD1D9E8) : Color(0xffCF1E2F);

  static Color get CLR_GREEN => isElite ? Color(0xffD1D9E8) : Color(0xff008936);
...
//TEXT COLORS
  ...
  static Color get TXT_CLR_DEFAULT =>
      isElite ? Color(0xffD1D9E8) : Color(0xff191919);
...
//DIVIDER
  ...
  static Color get CLR_DIVIDER_LITE =>
      isElite ? Color(0xffD1D9E8) : Colors.grey.withOpacity(0.2);
...
//BUTTON COLORS
  ...
  static Color get BTN_CLR_ACTIVE_BG_ALTER =>
      isElite ?  Color(0xff1B438B):Color(0xff94AFD8) ;

  static Color get BTN_CLR_ACTIVE_ALTER =>
      isElite ?  Color(0xffffffff):Color(0xff0E2146) ;
