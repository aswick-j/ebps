...
class AppColorsNonElite {
  static const CLR_BACKGROUND = Color.fromARGB(255, 255, 255, 255);
  static const CLR_CONTAINER_BG = Color(0xffD1D9E8);

  static const CLR_PRIMARY = Color(0xff1B438B);
  static const CLR_PRIMARY_LITE = Color(0xff94AFD8);
  static const CLR_SECONDARY = Color(0xff4969A2);

  static const CLR_GREY = Color(0xFFA4B4D1);
  static const CLR_ASTRIX = Color(0xff982F67);

  static const CLR_BLUESHADE = Color(0xCCACC9FF);
  static const CLR_GREENSHADE = Color(0xff99DDB4);
  static const CLR_REDSHADE = Color.fromARGB(255, 221, 153, 153);
  static const CLR_ORANGESHADE = Color.fromRGBO(221, 198, 153, 1);
  static const CLR_ERROR = Color(0xffCF1E2F);
  static const CLR_GREEN = Color(0xff008936);
  static const CLR_ORANGE = Color(0xFFCE7D1E);
  static const CLR_BLUE_LITE = Color(0xFF768EB9);
...
//button colors
  ...
  static const BTN_CLR_ACTIVE = Color(0xffffffff);
...
class AppColorsElite {
  static const CLR_BACKGROUND = Color(0xff0E2146);
  static const CLR_CONTAINER_BG = Color(0xffD1D9E8);

  static const CLR_PRIMARY = Color(0xff94AFD8);
  static const CLR_PRIMARY_LITE = Color(0xff94AFD8);
  static const CLR_SECONDARY = Color(0xff4969A2);
